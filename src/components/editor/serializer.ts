    ...
    case "file":
      return {
        ...
        attrs: {
          ...
          transcriptLanguage: block.media?.transcriptLanguage ?? null,
      ...
      return [
        {
          ...
          media: {
            ...
            transcriptLanguage: (attrs.transcriptLanguage as string) ?? undefined,
      ...
      const isVideo =
        ...
        (block.type === "file" &&
          (block.media?.mimeType?.startsWith("video/") ||
            (block.media?.name && isVideoFile({ name: block.media.name, type: block.media.mimeType }))));
